      ...
      balanceData.then((data) => {
        if (data.error) {
          this.setState({
            balances: null,
            reserved: null,
          }, () => showModal(`Updating balance failed with ${data.error}`));
        } else if (data.balances && data.reserved) {
          this.setState({
            ...
            <div className="header-wrapper">
              <div className="app__header-menu">
                <ul>
                  <li
                    className="shadowed"
                    onClick={this.props.addTradingItem.bind(this)}
                  >
                    <a>Add block</a>
                  </li>
                  <li
                    ...
                    <a>
                      <div className="balance-informer">
                        <div className="balance-informer__wrapper">
                          ...
                          >
                          Balance
                            <span className="shadowed-black scrollable">
                              <div className="balance app-block">
                                ...
                                <div className="balance__content shadowed scrollable">
                                  {rows}
                                </div>
                              </div>
                            </span>
