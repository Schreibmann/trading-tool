...
console.log(data);
    ...
    let avgBuyPrice = Math.ceil( (buyPrices.reduce((first, next) => first + next, 0)/buyPrices.length)*10000)/10000;
    ...
    let avgSellPrice = Math.ceil( (sellPrices.reduce((first, next) => first + next, 0)/sellPrices.length)*10000)/10000;
  ...
  render() {
    ...
    return (
        ...
        <div className="trading-item__wrapper shadowed">
          <div id={`trading-item__${this.props.id}`} className="trading-item app-block__item ">
              <Graph  id={this.props.id} pair={pair}
                autoRefresh={this.state.autoRefresh} 
