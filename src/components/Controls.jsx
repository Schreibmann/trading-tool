    	...
    	<div className="controls-wrapper shadowed">	    	
				  ...
				  <span className="switch">
					<span className="switch-border1">
						<span className="switch-border2">
							<input id={`bot-switcher_${this.props.id} `} type="checkbox" checked={this.props.trading} onChange={() => this.props.toggleTrading()}/>
							<label htmlFor={`bot-switcher_${this.props.id} `}></label>
				...
				<div className="switch-wrapper shadowed">
				  ...
				  <span className="switch">
					<span className="switch-border1">
						<span className="switch-border2">
							<input id={`log-switcher_${this.props.id} `} type="checkbox" checked={this.props.showConsole} onChange={() => this.props.toggleConsoleView()} />
							<label htmlFor={`log-switcher_${this.props.id} `}></label>
							<span className="switch-top"></span>
							<span className="switch-shadow"></span>
							<span className="switch-handle"></span>
							<span className="switch-handle-left"></span>
